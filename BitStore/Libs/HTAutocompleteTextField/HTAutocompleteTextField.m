...
@interface HTAutocompleteTextField () <UITextFieldDelegate>
...
- (BOOL)textFieldShouldReturn:(UITextField *)textField {
    return [self.autoCompleteTextFieldDelegate textFieldShouldReturn:textField];
}
...
- (CGRect)autocompleteRectForBounds:(CGRect)bounds
{
    ...
    CGRect autocompleteTextRect = [self.autocompleteLabel.text boundingRectWithSize:CGSizeMake(textRect.size.width-prefixTextSize.width, textRect.size.height)
                                                                        options:NSStringDrawingUsesLineFragmentOrigin|NSStringDrawingUsesFontLeading
                                                                     attributes:attributes context:nil];
    CGSize autocompleteTextSize = autocompleteTextRect.size;

    returnRect = CGRectIntegral(CGRectMake(textRect.origin.x,
...
{
    [self.autocompleteLabel setText:[NSString stringWithFormat:@"%@%@", self.text, self.autocompleteString]];
